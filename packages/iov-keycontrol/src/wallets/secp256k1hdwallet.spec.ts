  ...
  it("creates correct identities from paths", async () => {
    ...
    );
    {
      ...
      expect(identity.pubkey.data).toEqual(
        fromHex("03a7a8d79df7857bf25a3a389b0ecea83c5272181d2c062346b1c64e258589fce0"),
      );
    }
    {
      // m/0'/1
      ...
      expect(identity.pubkey.data).toEqual(
        fromHex("02ec5fd84554de89c53fcd0670f534930c6ec0cbe761d43a98f6557422e16d2561"),
      );
    }
    {
      // m/0'/1/0
      ...
      expect(identity.pubkey.data).toEqual(
        fromHex("02d26ce62f44e11c38a79cf7d7530ddd20572f8e7d14c38b0da38eee8aacde9bbc"),
      );
    }
    {
      // m/0'/1/1
      ...
      expect(identity.pubkey.data).toEqual(
        fromHex("03c3ff7a943318deacb0c426ac9b03bb69358d1c304eb13e1a2c2a458a46541a54"),
      );
    }
    {
      // m/0'/1/1/0'
      ...
      expect(identity.pubkey.data).toEqual(
        fromHex("03f6cbcea9d6a3ebd400b9a134e58f405cc19aff092d344755837099f3ea9258b4"),
      );
    }
    {
      // m/0'/1/1/1'
      ...
      expect(identity.pubkey.data).toEqual(
        fromHex("021bcecc3222b74948984b9b3a676814dcd8d7d6d5530caa7d7a3280bf034ba62c"),
      );
    }
  });
