...
describe("Ed25519HdWallet", () => {
  ...
  it("creates correct identities from paths", async () => {
    ...
    expect(identity0.pubkey.data).toEqual(
    ...
    expect(identity1.pubkey.data).toEqual(
    ...
    expect(identity2.pubkey.data).toEqual(
  ...
  it("can be cloned", () => {
    const original = Ed25519HdWallet.fromEntropy(
      fromHex("51385c41df88cbe7c579e99de04259b1aa264d8e2416f1885228a4d069629fad"),
    );
