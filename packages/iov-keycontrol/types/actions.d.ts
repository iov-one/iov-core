import { Nonce, PasswordString, PublicKeyBundle, SignedTransaction, UnsignedTransaction, UsernameString } from "@iov/types";
export declare const enum KeyActionType {
    ADD_USER = "ADD_USER",
...
export declare type KeyAction = AddUserAction | RemoveUserAction | UnlockUserAction | LockUserAction | CreateAccountAction | SetAccountNameAction | SignTransactionAction | VerifyTransactionAction;
