...
describe("Integers", () => {
  ...
  describe("Uint64", () => {
    ...
    it("can export bytes (little endian)", () => {
      ...
      ).toEqual([0x0d, 0x4e, 0x20, 0xa9, 0x5f, 0xbc, 0x22, 0xab]);
      expect(
