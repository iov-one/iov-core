...
import { Account, AccountQuery, Address, AddressQuery, AtomicSwap, BcpAtomicSwapConnection, BcpSwapQuery, BcpTicker, BcpTxQuery, BlockHeader, ChainId, ConfirmedTransaction, FailedTransaction, Nonce, PostableBytes, PostTxResponse, PubkeyQuery, TokenTicker } from "@iov/bcp-types";
...
export declare class BnsConnection implements BcpAtomicSwapConnection {
     ...
     */
    getSwapsFromState(query: BcpSwapQuery): Promise<ReadonlyArray<AtomicSwap>>;
    /**
     * All matching swaps that are open (in app state)
     *
     * To get claimed and returned, we need to look at the transactions.... TODO
     */
    getSwaps(query: BcpSwapQuery): Promise<ReadonlyArray<AtomicSwap>>;
    /**
     ...
     */
    watchSwaps(query: BcpSwapQuery): Stream<AtomicSwap>;
