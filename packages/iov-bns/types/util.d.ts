...
import { Address, ChainId, ConfirmedTransaction, Hash, Identity, LightTransaction, Nonce, SignableBytes, SwapAbortTransaction, SwapClaimTransaction, SwapOfferTransaction, TransactionQuery } from "@iov/bcp";
...
export declare function isConfirmedWithSwapOfferTransaction(tx: ConfirmedTransaction<LightTransaction>): tx is ConfirmedTransaction<SwapOfferTransaction>;
export declare function isConfirmedWithSwapClaimOrAbortTransaction(tx: ConfirmedTransaction<LightTransaction>): tx is ConfirmedTransaction<SwapClaimTransaction | SwapAbortTransaction>;
