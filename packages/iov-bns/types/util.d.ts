...
export declare function isConfirmedWithSwapOfferTransaction(tx: ConfirmedTransaction<UnsignedTransaction>): tx is ConfirmedTransaction<SwapOfferTransaction & WithCreator>;
export declare function isConfirmedWithSwapClaimOrAbortTransaction(tx: ConfirmedTransaction<UnsignedTransaction>): tx is ConfirmedTransaction<(SwapClaimTransaction | SwapAbortTransaction) & WithCreator>;
