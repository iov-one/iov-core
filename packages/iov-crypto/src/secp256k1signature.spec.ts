...
describe("Secp256k1Signature", () => {
  it("can be constructed", () => {
    const signature = new Secp256k1Signature(new Uint8Array([0x22, 0x33]), new Uint8Array([0xaa]), 7);
  ...
  it("throws when output size of r or s is too small", () => {
    const signature = new Secp256k1Signature(new Uint8Array([0x22, 0x33, 0x44]), new Uint8Array([0xaa, 0xbb]), 7);
  ...
  it("throws r with leading 0", () => {
    expect(() => new Secp256k1Signature(fromHex("00F25B86E1D8A11D72475B3ED273B0781C7D7F6F9E1DAE0DD5D3EE9B84F3FAB891"), new Uint8Array([0xaa]), 7)).toThrowError(/unsigned integer r must be encoded as unpadded big endian./i);
  });

  it("throws s with leading 0", () => {
    expect(() => new Secp256k1Signature(new Uint8Array([0xaa]), fromHex("00F25B86E1D8A11D72475B3ED273B0781C7D7F6F9E1DAE0DD5D3EE9B84F3FAB891"), 7)).toThrowError(/unsigned integer s must be encoded as unpadded big endian./i);
  });
  ...
  it("can encode as DER", () => {
    ...
    const signature = new Secp256k1Signature(fromHex("F25B86E1D8A11D72475B3ED273B0781C7D7F6F9E1DAE0DD5D3EE9B84F3FAB891"), fromHex("63D9C4E1391DE077244583E9A6E3D8E8E1F236A3BF5963735353B93B1A3BA935"), 7);
