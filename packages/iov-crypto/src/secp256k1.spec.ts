...
describe("Secp256k1", () => {
  ...
  it("has working keypair derivation", async () => {
    // example data generated by https://kjur.github.io/jsrsasign/sample/sample-ecdsa.html
    const privkey = fromHex("2045f3b48ccc196b5f73a862a271865b1aca80be39247636045d73dedd7016dc");
    const keypair = await Secp256k1.makeKeypair(privkey);
    expect(keypair.privkey).toEqual(fromHex("2045f3b48ccc196b5f73a862a271865b1aca80be39247636045d73dedd7016dc"));
    expect(keypair.pubkey).toEqual(fromHex("0422fc5f48b6468157e2f25c6829f19e8c13b811c3116287d89f80e0df20eb7bb11ca4b9bd574b3d48f2cd5c0fce6e6b10d04e461d6c00afd22206b112c4c04e70"));
  });
