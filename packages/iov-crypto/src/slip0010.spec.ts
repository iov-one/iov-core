...
import { Slip0010, Slip10Curve, Slip10RawIndex } from "./slip0010";
...
describe("Slip0010", () => {
  describe("Test vector 1 for secp256k1", () => {
    ...
    it("can derive path m", () => {
      ...
      const derived = Slip0010.derivePath(Slip10Curve.Secp256k1, seed, path);
  ...
  describe("Test vector 1 for ed25519", () => {
    ...
    it("can derive path m", () => {
      const path: ReadonlyArray<Slip10RawIndex> = [];
      const derived = Slip0010.derivePath(Slip10Curve.Ed25519, seed, path);
