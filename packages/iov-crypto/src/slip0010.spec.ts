...
describe("Slip0010", () => {
  describe("Test vector 1 for secp256k1", () => {
    ...
    it("can derive path m/0_H", () => {
      const path: ReadonlyArray<number> = [Slip0010.rawIndexFromHardened(0)];
      const derived = Slip0010.derivePath(Slip0010Curve.Secp256k1, seed, path);
    ...
    //
    // it("can derive path m/0_H/1", () => {
    //   const path: ReadonlyArray<number> = [Slip0010.hardenedIndex(0), Slip0010.normalIndex(1)];
    //   const derived = Slip0010.derivePath(Slip0010Curve.Secp256k1, seed, path);
  ...
  describe("Test vector 1 for ed25519", () => {
    ...
    it("can derive path m/0_H/1_H", () => {
      const path: ReadonlyArray<number> = [Slip0010.rawIndexFromHardened(0), Slip0010.rawIndexFromHardened(1)];
      const derived = Slip0010.derivePath(Slip0010Curve.Ed25519, seed, path);
    ...
    it("can derive path m/0_H/1_H/2_H", () => {
      const path: ReadonlyArray<number> = [Slip0010.rawIndexFromHardened(0), Slip0010.rawIndexFromHardened(1), Slip0010.rawIndexFromHardened(2)];
      const derived = Slip0010.derivePath(Slip0010Curve.Ed25519, seed, path);
    ...
    it("can derive path m/0_H/1_H/2_H/2_H", () => {
      const path: ReadonlyArray<number> = [Slip0010.rawIndexFromHardened(0), Slip0010.rawIndexFromHardened(1), Slip0010.rawIndexFromHardened(2), Slip0010.rawIndexFromHardened(2)];
      const derived = Slip0010.derivePath(Slip0010Curve.Ed25519, seed, path);
    ...
    it("can derive path m/0_H/1_H/2_H/2_H/1000000000_H", () => {
      const path: ReadonlyArray<number> = [Slip0010.rawIndexFromHardened(0), Slip0010.rawIndexFromHardened(1), Slip0010.rawIndexFromHardened(2), Slip0010.rawIndexFromHardened(2), Slip0010.rawIndexFromHardened(1000000000)];
      const derived = Slip0010.derivePath(Slip0010Curve.Ed25519, seed, path);
  ...
  describe("Test vector 2 for ed25519", () => {
    ...
    it("can derive path m/0_H/2147483647_H", () => {
      const path: ReadonlyArray<number> = [Slip0010.rawIndexFromHardened(0), Slip0010.rawIndexFromHardened(2147483647)];
      const derived = Slip0010.derivePath(Slip0010Curve.Ed25519, seed, path);
    ...
    it("can derive path m/0_H/2147483647_H/1_H", () => {
      const path: ReadonlyArray<number> = [Slip0010.rawIndexFromHardened(0), Slip0010.rawIndexFromHardened(2147483647), Slip0010.rawIndexFromHardened(1)];
      const derived = Slip0010.derivePath(Slip0010Curve.Ed25519, seed, path);
    ...
    it("can derive path m/0_H/2147483647_H/1_H/2147483646_H", () => {
      const path: ReadonlyArray<number> = [Slip0010.rawIndexFromHardened(0), Slip0010.rawIndexFromHardened(2147483647), Slip0010.rawIndexFromHardened(1), Slip0010.rawIndexFromHardened(2147483646)];
      const derived = Slip0010.derivePath(Slip0010Curve.Ed25519, seed, path);
    ...
    it("can derive path m/0_H/2147483647_H/1_H/2147483646_H/2_H", () => {
      const path: ReadonlyArray<number> = [Slip0010.rawIndexFromHardened(0), Slip0010.rawIndexFromHardened(2147483647), Slip0010.rawIndexFromHardened(1), Slip0010.rawIndexFromHardened(2147483646), Slip0010.rawIndexFromHardened(2)];
      const derived = Slip0010.derivePath(Slip0010Curve.Ed25519, seed, path);
